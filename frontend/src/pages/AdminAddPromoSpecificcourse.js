...
const AdminAddPromoSpecificcourse = () => {
  ...
  const Add = () => {
    ...
    Axios.post("http://localhost:8000/Adminstrator_addpromotion", {
        Title: Title,
        Promotion: Promotion,
  ...
  return (
    <div className="add">
      ...
      <br />
      <br />
      <div className="title">Adding promotion to specific course</div>
      <br />
      <br />
...
export default AdminAddPromoSpecificcourse;
